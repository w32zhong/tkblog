...
function get_code(token)
{
	var encoded_pw = hex_md5("g131517");
	var final_to_encode = encoded_pw + token;
	print("psw:" + hex_md5(final_to_encode));

	var encoded_pw_unicode = calcMD5("g131517");
	final_to_encode = encoded_pw_unicode + token;
	print("unicode_psw:" + calcMD5(final_to_encode));
}
