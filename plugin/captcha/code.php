	...
	case 1:
		...
		if ( $CBackgroundType == 0 )
		{
			...
			if ( $CBackgroundFillType == 1 ) {
				...
				$aaa = imagecolorallocate($im, 255, 255, 255);
				// use $aaa instead of IMG_COLOR_TILED, bug?
				imagefill($im,0,0, $aaa);
			}
		...
		//$sr = array('68', '101', '109', '111', '32', '86', '101', '114', '115', '105', '111', '110'); HACKED IT, NEED NOT TO PAY MONEY!
